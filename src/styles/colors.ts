...
export const colors: TColors = {
  ...
  // Primary colors
  primary: '#4CAF50', // Vibrant green for active states
  primaryBlue: '#2196F3', // Medium blue for preferred tags and left border
  ...
  // Tag colors
  lastMinute: '#FF4081', // Bright pink for last minute tags
  preferred: '#2196F3', // Medium blue for preferred tags
